...
<div id="DiscussionForm">
   ...
   <?php
      ...
      function _FireEvent($Controller, $EventName, $PluginName) {
         $MethodName = get_class($Controller)."_{$EventName}_Handler";
         $Instance = NULL;
         try {
            $Instance = Gdn::PluginManager()->GetPluginInstance($PluginName, Gdn_PluginManager::ACCESS_PLUGINNAME);
         } catch (Exception $Ex) {
         }
      ...
      // Add the tags and fileupload in the correct order.
      _FireEvent($this, 'BeforeFormButtons', 'FileUpload');
      _FireEvent($this, 'BeforeFormButtons', 'Cartalk');
      _FireEvent($this, 'BeforeFormButtons', 'Tagging');
//      Gdn::PluginManager()->GetPluginInstance('FileUpload', Gdn_PluginManager::ACCESS_PLUGINNAME)->PostController_BeforeFormButtons_Handler($this);
//      Gdn::PluginManager()->GetPluginInstance('Cartalk', Gdn_PluginManager::ACCESS_PLUGINNAME)->PostController_BeforeFormButtons_Handler($this);
//      Gdn::PluginManager()->GetPluginInstance('Tagging', Gdn_PluginManager::ACCESS_PLUGINNAME)->PostController_BeforeFormButtons_Handler($this);
