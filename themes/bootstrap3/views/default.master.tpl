    ...
    <footer class="page-footer sticky-footer">
      <div class="container">
        <div class="clearfix">
          ...
          <p class="pull-right hidden-xs PoweredByVanilla-Wrap">{t c="Built with"} <i class="InformSprite Heart"></i> {t c="and"} <a href="http://getbootstrap.com">Bootstrap</a>. {t c="Powered by"} <a href="{vanillaurl}">Vanilla Forums</a>
