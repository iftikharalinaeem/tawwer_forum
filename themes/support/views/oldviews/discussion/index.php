   ...
   <ul>
      <li><?php
         if (Gdn::Config('Vanilla.Categories.Use') === TRUE) {
            ...
            echo Anchor(T('All Questions'), 'discussions');
         }
      ?></li>
   </ul>
...
if ($this->Discussion->Closed == '1') {
   ...
   <div class="Foot Closed">
      <div class="Note Closed"><?php echo T('This question has been closed.'); ?></div>
      <?php echo Anchor(T('&larr; All Questions'), 'discussions', 'TabLink'); ?>
   </div>
<?php
...
?>
   <div class="Foot">
      <?php
      echo Anchor(T('Add an Answer'), Gdn::Authenticator()->SignInUrl($this->SelfUrl), 'TabLink'.(Gdn::Config('Garden.SignIn.Popup') ? ' SignInPopup' : ''));
      ?> 
   </div>
   <?php 
}
