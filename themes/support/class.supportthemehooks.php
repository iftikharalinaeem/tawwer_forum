...
class SupportThemeHooks implements Gdn_IPlugin {
   public function Setup() {
      ...
      if ($SQL->Select('CategoryID')->From('Category')->Where('Name', 'Question')->Get()->NumRows() == 0)
         $SQL->Insert('Category', array('InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => 'Question', 'UrlCode' => 'questions', 'Description' => 'Ask a question', 'Sort' => '1'));
      
      if ($SQL->Select('CategoryID')->From('Category')->Where('Name', 'Idea')->Get()->NumRows() == 0)
         $SQL->Insert('Category', array('InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => 'Idea', 'UrlCode' => 'ideas', 'Description' => 'Share an idea', 'Sort' => '1'));

      if ($SQL->Select('CategoryID')->From('Category')->Where('Name', 'Problem')->Get()->NumRows() == 0)
         $SQL->Insert('Category', array('InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => 'Problem', 'UrlCode' => 'problems', 'Description' => 'Report a problem', 'Sort' => '1'));

      if ($SQL->Select('CategoryID')->From('Category')->Where('Name', 'Kudos')->Get()->NumRows() == 0)
         $SQL->Insert('Category', array('InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => 'Kudos', 'UrlCode' => 'kudos', 'Description' => 'Give some kudos', 'Sort' => '1'));
      
      if ($SQL->Select('CategoryID')->From('Category')->Where('Name', 'Announcement')->Get()->NumRows() == 0)
         $SQL->Insert('Category', array('InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => 'Announcement', 'UrlCode' => 'announcements', 'Description' => 'Administrative announcements', 'Sort' => '1'));
