...
<body id="<?php echo $BodyIdentifier; ?>" class="<?php echo $this->CssClass; ?>">
   <div id="Frame">
					...
					if ($this->Menu) {
			         ...
			         $Authenticator = Gdn::Authenticator();
						if ($Session->IsValid()) {
							...
							$this->Menu->AddLink('SignOut', T('Sign Out'), $Authenticator->SignOutUrl(), FALSE, array('class' => 'NonTab'));
						} else {
							$Attribs = array();
      ...
      <div id="Foot">
			<div><?php
				printf(T('Powered by %s'), '<a href="http://vanillaforums.com"><span>VanillaForums.com</span></a>');
			?></div>
		</div>
   </div>
