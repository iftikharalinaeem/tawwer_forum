...
$this->Form->AddHidden('Garden.Registration.CaptchaPublicKey', Gdn::Config('Garden.Registration.CaptchaPublicKey'));
$this->Form->AddHidden('Garden.Registration.CaptchaPrivateKey', Gdn::Config('Garden.Registration.CaptchaPrivateKey'));
echo $this->Form->Open();
