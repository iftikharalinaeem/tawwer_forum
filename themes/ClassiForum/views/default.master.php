...
<body id="<?php echo $BodyIdentifier; ?>" class="<?php echo $this->CssClass; ?>">
   <div id="Frame">
      <div id="Head">
<a class="top-banner" href="<?php echo Url('/'); ?>"> <?php echo Img('/themes/ClassiForum/design/top_banner.jpg'); ?></a>

         <div class="Menu">
<a class="logo" href="<?php echo Url('/'); ?>"> <?php echo Img('/themes/ClassiForum/design/logo.png'); ?></a>
            <?php
