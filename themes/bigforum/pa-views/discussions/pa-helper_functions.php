...
<li class="<?php echo $CssClass; ?>">
   ...
   if ($Sender->CanEditDiscussions) {
      ...
      echo '<div class="AdminCheck"><input type="checkbox" name="DiscussionID[]" value="'.$Discussion->DiscussionID.'"'.($ItemSelected?' checked="checked"':'').' /></div>';
   }
   ?>
   <table>
      <tr>
         ...
         <td class="BigCount CountComments"><div class="Wrap"><?php echo Gdn_Format::BigNumber($Discussion->CountComments); ?></div></td>
         <td class="BigCount CountViews"><?php echo Gdn_Format::BigNumber($Discussion->CountViews); ?></td>
      </tr>
   </table>
</li>
<?php
...
<div class="Tabs DiscussionsTabs">
   <ul>
      ...
      <li<?php echo strtolower($Sender->ControllerName) == 'discussionscontroller' && strtolower($Sender->RequestMethod) == 'index' ? ' class="Active AllDiscussionsTab"' : ' class="AllDiscussionsTab"'; ?>><?php echo Anchor(T('All Discussions'), '/'); ?></li>
...
<table class="DiscussionHeading">
   <tr>
      ...
      <td class="CountHeading CountComments"><div class="Wrap">Replies</div></td>
      <td class="CountHeading CountViews">Views</td>
   </tr>
</table>
