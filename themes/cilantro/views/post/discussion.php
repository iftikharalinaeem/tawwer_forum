...
<div id="DiscussionForm">
   <h2><?php echo T(property_exists($this, 'Discussion') ? 'Edit Issue' : 'Create an Issue'); ?></h2>
   <?php
      echo $this->Form->Open();
      echo $this->Form->Errors();
      echo T('Describe the issue in as much detail as possible. Please copy exact error messages, include your web browser & version number, web server type & version, PHP version, MySQL version, etc.');
      echo $this->Form->TextBox('Body', array('MultiLine' => TRUE));
      echo $this->Form->Label('Issue Title', 'Name');
      echo $this->Form->TextBox('Name', array('maxlength' => 100));
      if (Gdn::Config('Vanilla.Categories.Use') === TRUE) {
         echo '<div class="Category">';
         echo $this->Form->Label('Product', 'CategoryID');
