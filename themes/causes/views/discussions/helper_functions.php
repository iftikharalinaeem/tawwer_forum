...
function WriteDiscussion($Discussion, &$Sender, &$Session, $Alt) {
   ...
   if ($Discussion->FirstPhoto == '')
      $First->Photo = Url('applications/dashboard/design/images/usericon.gif', TRUE);
   ...
   if ($Discussion->Announce == '1')
      $DiscussionName = T('Announcement: ').$DiscussionName;

   if ($Discussion->Closed == '1')
      $DiscussionName = T('Closed: ').$DiscussionName;
