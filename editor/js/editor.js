...
$(function() {
   var editor = new wysihtml5.Editor('Form_Body', {
      // Give the editor a name, the name will also be set as class name on the iframe and on the iframe's body 
      name:                 'vanilla-editor-text',
      ...
      stylesheets:          ['/vanilla/plugins/editor/design/editor.css'],
   ...
   editor.toggleFullpage = function() { 
   ...
   // toggle fullpage on click
   $("#editor-toggle-fullpage-button").click(editor.toggleFullpage);
   // exit fullpage on esc
   $(document).keyup(function(e) {
      if ($('body').hasClass('js-editor-fullpage') && e.which == 27) {
         editor.toggleFullpage();
      }
   });  
