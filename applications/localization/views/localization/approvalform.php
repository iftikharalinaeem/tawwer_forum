...
echo $this->Form->Open(array('id' => 'TranslationForm', 'action' => Url('/localization/approve.json?locale='.urlencode($this->Data('Locale.Locale')))));
...
echo $this->Form->Button('Change');
echo $this->Form->Button('Reject', array('accesskey' => 'r'));
echo $this->Form->Button('Approve', array('accesskey' => 'a'));
echo '</div>';
