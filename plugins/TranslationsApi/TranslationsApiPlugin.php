...
class TranslationsApiPlugin extends Gdn_Plugin {
    ...
    public function structure() {
        $this->database->structure()
            ...
            ->column("translationPropertyKey", "varchar(255)", false, ["index", "unique.resourceRecordKey"])
        ...
        $this->database->structure()
            ...
            ->column("translationPropertyKey", "varchar(255)", false, ["index","unique.Key"])
            ->column("dateInserted", "datetime")
            ->column("dateUpdated", "datetime")
            ->set()
        ;
        ...
        $this->database->structure()
            ...
            ->column("urlCode", "varchar(32)", false, ["index","unique.resourceKey"])
            ->column("dateInserted", "datetime")
            ->column("dateUpdated", "datetime")
            ->set()
        ;
