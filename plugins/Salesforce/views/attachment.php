...
/**
 * Writes attachments for Salesforce leads.
 *
            ...
            <div class="media-body">
               ...
               <div class="item-header">
                  <h4 class="media-heading item-heading"><?php echo T('Lead') ?> · <a rel="nofollow"
                       href="<?php echo C('Plugins.Salesforce.AuthenticationUrl'); ?>/<?php echo $attachment['SourceID']; ?>"><?php echo ucfirst($attachment['Source']); ?></a>
                     <div class="item-meta">
               ...
               <div class="item-body">
                  ...
                  <dl class="dl-columns">
                     ...
                     <dd><a rel="nofollow" href="<?php echo C('Plugins.Salesforce.AuthenticationUrl'); ?>/<?php echo $attachment['SourceID']; ?>"><?php echo $leadName; ?></a></dd>
...
/**
 * Writes attachments for salesforce cases.
 * @param array $attachment
 */
      ...
      <div class="alert">
         <div class="media item">
            ...
            <div class="media-body">
               ...
               <div class="item-header">
                  <h4 class="media-heading item-heading"><?php echo T('Case') ?> · <a rel="nofollow"
                                                                   href="<?php echo C('Plugins.Salesforce.AuthenticationUrl'); ?>/<?php echo $attachment['SourceID']; ?>"><?php echo ucfirst($attachment['Source']); ?></a>
                     <div class="item-meta">
                        <span><?php echo Gdn_Format::Date($attachment['DateInserted'], 'html') ?> <?php echo T('by'); ?>
                           <?php echo $attachment['InsertUser']['ProfileLink']; ?></span>
               ...
               <div class="item-body">
                  ...
                  <dl class="dl-columns">
                     ...
                     <dd><a rel="nofollow" href="<?php echo C('Plugins.Salesforce.AuthenticationUrl'); ?>/<?php echo $attachment['SourceID']; ?>"><?php echo $attachment['CaseNumber']; ?></a></dd>
                     <dt><?php echo T('Status'); ?></dt>
                     <dd><?php echo $attachment['Status']; ?></dd>
                     <dt><?php echo T('Last Updated'); ?></dt>
                     <dd><?php echo Gdn_Format::Date($attachment['LastModifiedDate'], 'html') ?></dd>
                     <dt><?php echo T('Priority'); ?></dt>
                     <dd><?php echo $attachment['Priority']; ?></dd>
                  </dl>
               </div>
