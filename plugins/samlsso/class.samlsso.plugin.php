...
//         $xml = $response->document->saveXML();
         ...
         Logger::event('saml_response_received', LogLevel::DEBUG, "SAML response received.", array('samlresponse' => $Sender->Request->Post('SAMLResponse')));
         ...
         try {
            ...
            Logger::event('saml_response_invalid', LogLevel::ERROR, $ex->getMessage(), array('code' => $ex->getCode()));
            throw $ex;
         }
