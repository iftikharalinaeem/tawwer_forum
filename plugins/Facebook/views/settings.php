...
<div class="Configuration">
   ...
   <div class="ConfigurationHelp">
      ...
      <p><?php echo Anchor(Img('/plugins/Facebook/design/help-siteurl.png'), '/plugins/Facebook/design/help-siteurl.png', array('target' => '_blank')); ?></p>
      ...
      <p><?php echo Anchor(Img('/plugins/Facebook/design/help-appvalues.png'), '/plugins/Facebook/design/help-appvalues.png', array('target' => '_blank')); ?></p>
   </div>
</div>
<?php 
