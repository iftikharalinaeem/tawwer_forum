...
class WhosOnlinePlugin implements Gdn_IPlugin {
   ...
   public function Base_Render_Before(&$Sender) {
      ...
      $Session = Gdn::Session();     
		...
		// Only show on user-facing (non-admin) pages
      ...
      if (!InArrayI($Sender->ControllerName, array('categoriescontroller', 'discussioncontroller', 'discussionscontroller')) && $ConfigItem == 'discussion')
			return; 
