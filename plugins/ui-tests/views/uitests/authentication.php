...
<div id="uiTests-authenticationTests">
    <h2>SSO Methods <a href="<?php echo url('/authenticate/signin'); ?>" target="_blank">/authenticate/signin</a></h2>
    <div class="authenticateUserCol">
        <div id="uitest-ssomethods"></div>
    </div>

    <h2>Simple Password Form <a href="<?php echo url('/authenticate/password'); ?>" target="_blank">/authenticate/password</a></h2>
    <div class="authenticateUserCol">
    ...
    <h2>Recover Password <a href="<?php echo url('/authenticate/recoverpassword'); ?>" target="_blank">/authenticate/recoverpassword</a></h2>
