    ...
    <form class="_searchBar-form" action="" method="post">
        <div class="_searchBar-bar">
            <label class="_searchBar-inputAndIcon">
                <input class="inputText _searchBar-input" type="search" role="searchbox" placeholder="Type your search here">
            ...
            {*<button type="button" aria-label="Clear Search Field" class="button _searchBar-clearSearch">*}
    ...
    {if $advanced|default:'false' === "true"}
        <div id="advancedSearchFields" aria-label="Advanced Search Fields" aria-expanded="false" class="_searchBarAdvanced">
            <div class="_searchBarAdvanced-contents">
                ...
                <div class="inputBlock inputBlock-miniInputs">
                    <span class="inputBlock-labelAndDescription">
                        <span class="inputBlock-labelText">
                            Date Within
                        </span>
                    ...
                    <span class="inputBlock-inputWrap inputBlock-inlineLabelWrap">
                        <span class="inputBlock-labelText inputBlock-inlineLabel">
                            of
                        </span>
                    </span>
