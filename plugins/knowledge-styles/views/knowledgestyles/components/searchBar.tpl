    ...
    <form class="_searchBar-form" action="" method="post">
        <div class="_searchBar-bar">
            <label class="_searchBar-inputAndIcon">
                <input class="inputText _searchBar-input" type="search" role="searchbox" aria-autocomplete="list" aria-haspopup="true" aria-owns="[id of results]" aria-expanded="false" aria-activedescendant="[id of active descendant]" placeholder="Type your search here">
