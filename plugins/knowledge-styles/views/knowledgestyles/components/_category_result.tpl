        ...
        <div class="_searchResult-head">
            ...
            {if $excel}
                <svg class="_formatIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <title>Excel</title>
                    <rect x="3" y="3" width="18" height="18" rx="1" ry="1" stroke="currentColor" stroke-width=".5" style="fill: #2f7d32;"/>
            ...
            {if $word}
                <svg class="_formatIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <title>Word</title>
                    <rect x="3" y="3" width="18" height="18" rx="1" ry="1" stroke="currentColor" stroke-width=".5" style="fill: #2b5599;"/>
            ...
            {if $pdf}
                <svg class="_formatIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <title>PDF</title>
                    <rect x="3" y="3" width="18" height="18" rx="1" ry="1" stroke="currentColor" stroke-width=".5" style="fill: #ff3934;"/>
