{container id="forDemo" class="_panelAndNav"}
    <div class="_section _panelAndNav-left">
        ...
        {layoutWidget class="_panelAndNav-leftBottom _panelAndNav-sticky"}
    ...
    <div class="_panelAndNav-content">
        ...
        <div class="_section _panelAndNav-right">{* Hidden in 1 or 2 column media queries *}
            {layoutWidget class="_panelAndNav-rightTop"}
                {include "article_toc.tpl"}
            {/layoutWidget}
            {layoutWidget class="_panelAndNav-rightBottom"}
