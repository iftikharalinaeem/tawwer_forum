...
if ($About == 'customdomain') {
   ...
   <div class="Legal">
      ...
      <ol>
         ...
         <li>Create a <strong>C record</strong> for your domain, pointing at your Vanilla forum's address: <strong><?php
            echo str_replace(
               array('http://', '/'),
               array('', ''),
               Gdn::Config('Garden.Domain', 'your_forum_name.vanillaforums.com')
            );
         ?></strong>
