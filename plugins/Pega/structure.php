...
$Structure
   ...
   ->Column('Type', 'varchar(64)') // ex: pega-lead, pega-ticket
   ...
   ->Column('Source', 'varchar(64)') // ex: Pega
   ->Column('SourceID', 'varchar(32)') // ex: 500i0000007T43IAAS
   ->Column('SourceURL', 'varchar(255)') // ex: https://login.pega.com/500i0000007T43IAAS
