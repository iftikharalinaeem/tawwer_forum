...
import { IPostThemeRequest, IPatchThemeRequest } from "@themingapi/theme/ThemeModel";
...
*/
    ...
    public static postTheme_ACs = actionCreator.async<IPostThemeRequest, IPostThemeResponse, IApiError>("POST");
