            ...
            <Container fullGutter>
                <div className={classes.content}>
                    <Paragraph className={classes.description}>
                        This is a style guide of your theme. It has examples of the visual elements used throught the
                        application. You can click on the various widgets such as the menu or hero to edit their
