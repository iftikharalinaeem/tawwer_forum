...
/**
 * Originally in own advanced.js file.
 */
  ...
  (function($) {
    ...
    Wysihtml5SizeMatters = (function() {
      ...
      Wysihtml5SizeMatters.prototype.setupEvents = function() {
        ...
        return this.$body.on('keyup keydown keypress paste change', function() {
      ...
      Wysihtml5SizeMatters.prototype.adjustHeight = function() {
        ...
        console.log(this.$body[0].offsetHeight || this.$body[0].scrollHeight);
...
(function () {
  ...
  setupRegularResize = (function () {
    ...
    a.prototype.watchForChanges = function () {
      var a = this;
      this.$source.on("keyup keydown paste change focus", function () {
