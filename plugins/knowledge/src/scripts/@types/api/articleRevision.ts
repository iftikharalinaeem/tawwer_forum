...
// The record
export interface IArticleRevision extends IArticleRevisionRequiredData, IArticleRevisionDefaultedData, IArticleRevisionServerManagedData {}

// Request/Response interfaces
export interface IPostArticleRevisionRequestBody extends IArticleRevisionRequiredData, Partial<IArticleRevisionDefaultedData> {}
