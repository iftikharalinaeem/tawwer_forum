...
//         mockApi.onGet("/articles/1/translations").reply(200, dummyArticleTranslations);
//     });
...
//             .replyOnce(200, dummyEditArticle)
//             .onGet("/articles/1?expand=all")
//             .replyOnce(200, dummyEditArticle)
//             .onGet("/articles/1?expand=all&locale=en")
//             .replyOnce(200, dummyArticle)
//             .onAny()
//             .reply(config => {
//                 throw new Error(
//                     "No matching found for URL " +
//                         config.url +
...
//     const dummyArticleTranslations = [
//         {
//             articleRevisionID: 5,
...
//             expect(history.location.pathname).eq("/kb/articles/add", `Bad pathname` + history.location.pathname);
//             expect(mockStore.getActions()).deep.equals([], "Bad actions" + JSON.stringify(mockStore.getActions()));
//         });
...
//             mockApi
//                 .onGet("/articles/from-discussion", { params: { discussionID: 1 } })
...
//             mockGetEditAPI();
//             mockApi.onGet("/article-revisions/6").replyOnce(200, dummyRevision);
...
//                 .onGet(`/articles/${dummyArticle.articleID}?expand=all&locale=en`)
//                 .replyOnce(200, dummyArticle);
...
//             mockApi
//                 .onPatch(`/articles/${dummyArticle.articleID}`)
//                 .replyOnce(200, dummyArticle)
//                 .onGet(`/articles/${dummyArticle.articleID}?expand=all`)
//                 .replyOnce(200, dummyArticle);
