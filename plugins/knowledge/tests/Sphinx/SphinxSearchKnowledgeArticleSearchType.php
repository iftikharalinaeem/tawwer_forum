 ...
 */
class SphinxSearchKnowledgeArticleSearchType extends KbApiTestCase {
    ...
    public function testSearchByyKnowledgeBaseID() {
        ...
        $this->articleRecord($knowledgeBase['rootCategoryID'], 'distinct', 'no relation');
        ...
        $this->assertEquals('distinct', $results[0]['name']);
    }
