...
import { IWebhook, IWebhookFormState, INITIAL_WEBHOOK_FORM } from "@webhooks/WebhookTypes";
...
export class WebhookActions extends ReduxActions {
    ...
    public static readonly getEditWebhookACs = actionCreator.async<{ webhookID: number }, IWebhook, IApiError>(
        "GET_EDIT",
    );
    ...
    public static deleteWebhookACs = actionCreator.async<IDeleteWebhookRequest, IDeleteWebhookResponse, IApiError>(
        "DELETE",
    );
