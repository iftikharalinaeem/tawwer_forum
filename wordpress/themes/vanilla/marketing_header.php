...
<head>
  ...
  <link href="<?php bloginfo('stylesheet_url'); ?>" rel="stylesheet" type="text/css" media="screen" />
    <link href="<?php bloginfo('template_directory'); ?>/marketing.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php bloginfo('template_directory'); ?>/blue.css" rel="stylesheet" type="text/css" media="screen" />
...
<script type="text/javascript">
   ...
   Cufon.replace('div.Info p, div.videoDesc p, p.SubSubHead, .Friends p, div.post_events_single h3, #FeatureCopy h4, .FeatureCode h4', {
      fontFamily: 'GothamRound',
	  color: '#003B82',
	  fontSize: '16px',
      textShadow: '0px 1px 1px #fff;'
...
<div id="Head" class="Wrapper">
   <div class="Center">
      <div class="Logo">
         <a href="http://www.vanillaforums.com"><i class="Sprite SpriteLogo"><span>Vanilla Forums</span></i></a>
      </div>
      <div class="Menu">
            ...
            <div class="Blog"><a href="http://vanillaforums.com/blog"><span><i class="Sprite SpriteBlog"></i> Blog</span></a></div>
