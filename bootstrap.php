...
$dic->setInstance(Garden\Container\Container::class, $dic)
    ...
    ->rule( \Vanilla\Cloud\ElasticSearch\Driver\ElasticSearchDriver::class)
    ...
    ->addCall('registerActiveDriver', [new Reference(\Vanilla\Cloud\ElasticSearch\Driver\ElasticSearchDriver::class)])
