...
//      return;
      ...
      $Discussion_Map = array(
          ...
          'body' => array('Column' => 'Body', 'Filter' => array($this, 'CleanBody')),
      ...
      $Media_Map = array(
          'filename' => 'Name',
          'extension' => array('Column' => 'Type', 'Filter' => array($this, 'MimeType')),
          'filesize' => 'Size',
...
where m.message_cc <> '';");
   ...
   public function GuessFormat($Value) {
   ...
   public function CleanBody($Value) {
      if (strpos($Value, '[') !== FALSE) {
